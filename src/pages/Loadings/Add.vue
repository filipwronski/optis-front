                                ...
                                <v-flex md6 class="px-1">
                                    ...
                                    >
                                        <v-text-field
                                                ...
                                                readonly
                                        />
                                        <v-date-picker v-model="loadingDate" no-title scrollable actions>
                                ...
                                <v-flex md6 class="px-1">
                                    ...
                                    >
                                        <v-text-field
                                                ...
                                                readonly
                                        />
                                        <v-date-picker v-model="goDate" no-title scrollable actions>
                                            <template slot-scope="{ save, cancel }">
                                                <v-card-actions>
                                                    <v-spacer/>
                                                    <v-btn flat color="primary" @click="cancel">Cancel</v-btn>
                                ...
                                <v-flex md6 class="px-1">
                                    ...
                                    >
                                        <v-text-field
                                                ...
                                                readonly
                                        />
                                        <v-date-picker v-model="comeDate" no-title scrollable actions>
                                            <template slot-scope="{ save, cancel }">
                                                <v-card-actions>
                                                    <v-spacer/>
                                                    <v-btn flat color="primary" @click="cancel">Cancel</v-btn>
